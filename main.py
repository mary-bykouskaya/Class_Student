class Student:
    ...
    def score_average(self):
        ...
        if len(self.exam_scores) > 0:
            ...
            print(f"Average score of the student {self.first_name} is:", end='')
            return average_score
        else:
            return f"The student {self.first_name} didn't pass any exam yet"
...
if __name__ == '__main__':
    ...
    s1.show_scores()
    print(s1.course_passed())
    s2.show_scores()
    print(s2.course_passed())
    s3.show_scores()
    print(s3.course_passed())
    s4.show_scores()
    print(s4.course_passed())
    s5.show_scores()

    print(s5.course_passed())
    print(s1.score_average())
    print(s2.score_average())
    print(s3.score_average())
    print(s4.score_average())
    print(s5.score_average())
